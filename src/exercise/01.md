...
- Adding `<script type="module">` allows for JS interaction in your webpage
- Creating divs using JS, `document.createElement('div')`
- Must append to root for it to register
- Use `document.body.append(div)` to bypass `id='root'`
- `id="root'` belongs on a `div` not on a `body`
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=irisjyuan%40gmail.com).
