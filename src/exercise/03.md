...
- Adding `{...props}` to a component inserts all the props, useful if there are
  a lot but matters what they are named
- Order matters in spreading props, later overrides earlier
- The `<div />` syntax is JSX only
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=irisjyuan%40gmail.com).
